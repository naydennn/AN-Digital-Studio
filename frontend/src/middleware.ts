...
function addSecurityHeaders(response: NextResponse): void {
  ...
  response.headers.set(
    ...
    [
      ...
      "connect-src 'self' https://www.google-analytics.com https://region1.google-analytics.com https://analytics.google.com https://*.andigital.bg https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/",
